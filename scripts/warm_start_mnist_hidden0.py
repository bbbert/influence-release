...
num_steps = 300000
parser = argparse.ArgumentParser(description='Input start step #.')
...
def retrain_with_seed(seed):
    ...
    #num_steps = 300000 #######
    damping = 2e-2
    model_name = 'mnist_small_all_cnn_c_hidden0_seed{}_iter-{}'.format(seed, start_step) #num_steps
